...
export type GetPagesQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', id: string, slug: string, heading: string, body: { __typename?: 'RichText', html: string, text: string } }> };

export type GetPagesLazyQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
}>;


export type GetPagesLazyQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', id: string, slug: string, heading: string, body: { __typename?: 'RichText', html: string, text: string } }> };
